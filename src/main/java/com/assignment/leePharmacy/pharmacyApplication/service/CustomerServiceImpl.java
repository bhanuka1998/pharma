...
public class CustomerServiceImpl implements CustomerService{
    ...
    @Override
    public Customer getCustoerByEmail(String email) {
        Optional<Customer> optionalCustomer = Optional.ofNullable(
                customerRepository.findCustomerByCusEmail(email).orElseThrow(() -> new IllegalArgumentException("Customer not found"))
        );
