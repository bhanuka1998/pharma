...
public class CustomerController {
    ...
    @RequestMapping(value = "/getCustomerByEmail/{email}")
    private Customer gtCustomerByEmail(@PathVariable String email){
        return customerService.getCustoerByEmail(email);
    }
